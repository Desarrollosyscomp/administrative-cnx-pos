...
export const __name__(pascalCase)Service = {
  add: async (data: object) => {
    return axios.post({
      url:`${URL_API}/__name__(kebabCase)`,
      data
    });
  },
  edit: async (id: string, data: object) => {
    return axios.put({
      url:`${URL_API}/__name__(kebabCase)/${id}`,
      data,
      config:{
      headers: {
  ...
  // ) => {
  //   return axios.post(
  //     `${URL_API}/page/__name__(kebabCase)`,
  //     {
  //       where: search,
  ...
  getPaginated: async (
    ...
    return axios.get({
      url:`${URL_API}/__name__(kebabCase)/find/pagination`,
      config:{
        params: {
          page: page,
          limit: limit,
