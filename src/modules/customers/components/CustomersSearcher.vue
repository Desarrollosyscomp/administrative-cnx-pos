...
const submit = async () => {
  try {
    appStore.afterLoading(async () => {
      customersStore.advancedSearchActive = true
      customersStore.search = formData.search;
      customersStore.isActive = formData.isActive;
      customersStore.initDate = formData.initDate;
      customersStore.endDate = formData.endDate;
