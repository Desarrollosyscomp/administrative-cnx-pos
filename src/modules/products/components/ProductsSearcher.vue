...
const submit = async () => {
  try {
    appStore.afterLoading(async () => {
      productsStore.advancedSearchActive = true
      productsStore.search = formData.search;
      productsStore.isActive = formData.isActive;
      productsStore.initDate = formData.initDate;
      productsStore.endDate = formData.endDate;
