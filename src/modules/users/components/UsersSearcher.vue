...
const submit = async () => {
  try {
    appStore.afterLoading(async () => {
      usersStore.advancedSearchActive = true
      usersStore.search = formData.search;
      usersStore.isActive = formData.isActive;
      usersStore.initDate = formData.initDate;
      usersStore.endDate = formData.endDate;
      usersStore.page = 1;
