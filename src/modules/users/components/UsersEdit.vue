  ...
  <v-container>
    ...
    <div>
      <v-form @submit.prevent="submitNewPassword">
        ...
        <v-text-field label="Nueva contraseña" prepend-inner-icon="mdi-lock" variant="outlined" density="compact"
          class="mb-2" :type="visible1 ? 'text' : 'password'" v-model="formData.newPassword"
        ...
        <v-text-field label="Confirmar contraseña" prepend-inner-icon="mdi-lock" variant="outlined" density="compact"
          class="mb-2" :type="visible2 ? 'text' : 'password'" v-model="formData.confirmPassword"
...
const validations = {
  currentPassword: Yup.string().required("La contraseña actual es requerida").trim(),
  ...
  newPassword: Yup.string().trim().test(
    "is-valid-password",
